  ...
  .then(usersCreated => {
    ...
    let trips = [
      ...
      },
      {
        ...
        originCoordinates: [Number],
        destination: "c/ Gregorio Vacas 7",
        destinationCoordinates: [Number],
        day: 01 / 06 / 2019,
        time: "07:15",
        passengers: 3,
      ...
      },
      {
        ...
        originCoordinates: [Number],
        destination: "c/ Gregorio Vacas 1",
        destinationCoordinates: [Number],
        day: 01 / 06 / 2019,
        time: "07:15",
        passengers: 3,
      ...
      },
      {
        ...
        originCoordinates: [Number],
        destination: "c/ Viloria de la Rioja 15",
        destinationCoordinates: [Number],
        day: 01 / 06 / 2019,
        time: "07:15",
        passengers: 3,
      ...
      },
      {
        ...
        originCoordinates: [Number],
        destination: "c/ Viloria de la Rioja 1",
        destinationCoordinates: [Number],
        day: 01 / 06 / 2019,
        time: "07:15",
        passengers: 3,
      ...
      },
      {
        ...
        originNeighb: "Usera",
        destNeighb: "Puente Vallecas",
        origin: "c/ Mariano Vela 8",
        originCoordinates: [Number],
        destination: "c/ Palomeras 13",
        destinationCoordinates: [Number],
        day: 01 / 06 / 2019,
        time: "07:15",
        passengers: 3,
    ...
    trips = trips.map(elm => {
      return {
        ...
        origin: elm.origin += ", Madrid",
        destination: elm.destination += ", Madrid",
        day: elm.day,
        time: elm.time,
        passengers: [],
